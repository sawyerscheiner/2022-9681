 ...
 */
@Autonomous(name="AutoTest22BlueLeft", group="Iterative Opmode")
public class AutoTest22BlueLeft extends OpMode
{
    /*
    ---MOTORS---
     */
 ...
 //   extendArmState extendFirst;
  ...
  //  extendArmState extendBack;
    ...
    public void init() {
        ...
        ---USING STATES---
         */
        strafeLeft = new driveState(27, 0.2, motors, "strafeRight"); //first move left (but is actually right because our things arte switched
       ...
       // extendBack = new extendArmState(100, -1.0, extendArm);
        ...
        turnLeft = new driveState(24, 1.0, motors, "turnRight");
